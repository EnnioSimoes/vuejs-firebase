...
/***/ function(module, exports, __webpack_require__) {
	...
	var _firebaseDb = __webpack_require__(8);
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            rooms: [{ id: "001", name: "PHP", description: "Só fera do PHP" }, { id: "002", name: "Java", description: "Só fera do Java" }, { id: "003", name: "C#", description: "Só fera do C#" }, { id: "004", name: "C++", description: "Só fera do C++" }, { id: "005", name: "Javascript", description: "Só fera do Javascript" }, { id: "006", name: "VueJs", description: "Só fera do VueJs" }],
	            name: '',
	            email: '',
	            room: null
	        };
	    ...
	    methods: {
	        login: function login(room) {
	            localStorage.setItem('name', this.name);
	            localStorage.setItem('email', this.email);
	            localStorage.setItem('photo', 'http://www.gravatar.com/avatar/' + (0, _blueimpMd2.default)(this.email) + '.jpg');
	            $('#modalLoginEmail').modal('hide');
	            this.$route.router.go('/chat/' + this.room.id);
	        },
	        openModal: function openModal(room) {
	            this.room = room;
